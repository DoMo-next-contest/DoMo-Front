                ...
                TableCalendar(
                  ...
                  calendarStyle: const CalendarStyle(
                    ...
                    selectedDecoration: BoxDecoration(
                      color: Color(0xFFBF622C), shape: BoxShape.circle),
                  ),
                ),
          ...
          child: Container(
            ...
            child: Stack(children: [
              ...
              Positioned(
                ...
                child: InkWell(
                  ...
                  child: Container(
                    ...
                    child: Text(currentTask.category,
              ...
              Positioned(
                ...
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  const Padding(
                    ...
                    child: Text('하위작업', style: TextStyle(fontSize: 18, fontWeight: FontWeight.w400)),
                  ),
                  Expanded(
                          ...
                          return Padding(
                            ...
                            child: Container(
                              ...
                              child: Row(children: [
                                ...
                                // trailing buttons
                                if (_isEditing) ...[
                                  IconButton(icon: const Icon(Icons.edit_outlined), onPressed: () => currentTask.touch()),
                                  ...
                                  IconButton(
                                    ...
                                    onPressed: () => setState(() => isRunning ? _pauseSubtask(sub) : _startSubtask(sub)),
                                  ),
                                ],
                              ]),
                            ),
                          ...
                          final ok = await showDialog<bool>(
                                ...
                                builder: (_) => AlertDialog(
                                  ...
                                  actions: [
                                    ...
                                    TextButton(onPressed: () => Navigator.pop(context, true), style: TextButton.styleFrom(foregroundColor: Colors.red), child: const Text('삭제')),
                                  ],
                                ),
                              ) ??
                              false;
                          if (ok) {
                            setState(() => globalTaskList.remove(currentTask));
                            Navigator.pop(context);
                          }
                        },
              ...
              const Positioned(
                ...
                right: 0,
                bottom: 0,
                child: SizedBox(height: 56, child: _BottomNavBar(activeIndex: 1)),
              ),
            ]),
          ),
        ),
          ...
          child: InkWell(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(labels[i], style: TextStyle(fontFamily: 'Inter', fontSize: 13, fontWeight: weight, color: color, height: 1.08, letterSpacing: -0.5)),
              ],
            ),
          ),
        );
